"""
ESTrader AI -- watchdog_es.py  (Galahad)
Monitors main_estrader.py and automatically restarts on crash or freeze.
...
MAIN_SCRIPT   = BASE_DIR / "main_estrader.py"
...
log = logging.getLogger("ESTrader.Galahad")
...
class Watchdog:
    ...
    def _launch(self) -> None:
        ...
        log.info("ESTrader AI started (PID %d)", self._proc.pid)
    ...
    def _check_restart_flag(self) -> bool:
        ...
        if RESTART_FLAG.exists():
            ...
            log.info("restart.flag detected -- restarting ESTrader AI")
            return True
        return False
    ...
    def _do_restart(self, reason: str) -> bool:
        ...
        if self._alive():
            ...
            log.info("ESTrader AI restarted (PID %d)", self._proc.pid)
    ...
    def _handle_limit_exceeded(self) -> None:
        self._prune_restarts()
        msg = (
            f"ESTrader AI crashed {MAX_RESTARTS}x in 1 hour. "
    ...
    def _maybe_heartbeat(self) -> None:
        ...
        log.info(
            "Galahad heartbeat -- ESTrader AI running for %.1f hours",
            uptime_h,
        )
        self._heartbeat_at = time.monotonic()
    ...
    def run(self) -> None:
        log.info("=" * 60)
        log.info("  ESTrader AI -- Galahad Watchdog")
        ...
        try:
            ...
            log.error("FATAL: Could not start ESTrader AI: %s", exc)
            return
    ...
    def shutdown(self) -> None:
        ...
        _push("Shutdown", "ESTrader AI stopped cleanly.")
