...
regime as CONTEXT for Arthur's prompt. Bidirectional (23 Jul 2026): regime no
longer gates direction or confidence -- the daily SSL sets direction and LONG/SHORT
share one confidence floor. This is informational only:
...
log = logging.getLogger("ESTrader.Regime")

BASE_DIR = Path(__file__).resolve().parent
# Relative to the desk root: .../Desktop/ESTraderAI -> .../Desktop/GaiusAI/logs
...
def _read_file() -> dict:
    ...
    failure falls back to BULL (the confirmed regime as of 18 Jul 2026); this is
    context only and no longer affects direction or the confidence bar."""
    try:
