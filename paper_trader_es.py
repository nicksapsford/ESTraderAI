"""
ESTrader AI -- paper_trader_es.py  (Stanley)
Records every US500 spread bet trade and tracks running P&L.
Persists state between sessions via logs/es_trades.csv.
"""
...
from strategy_es import USTrade, TRAILING_STOP_POINTS, DEFAULT_GBPUSD

log = logging.getLogger("ESTrader.Stanley")
...
class PaperTraderES:
    ...
    def _restore_state(self) -> None:
        ...
        if not STATE_FILE.exists():
            return
        try:
            from strategy_es import should_force_close
    ...
    def _save_summary(self) -> None:
        ...
        lines = [
            "=" * 50,
            "ESTrader AI -- Stanley Paper Trader Summary",
    ...
    def open_trade(self, direction: str, price: float, session_phase: str = "",
                   ...
                   fast_path_uther_confidence: str = "") -> USTrade:
        """Open a new paper trade and log it."""
        from strategy_es import open_trade
    ...
    def close_trade(self, price: float, reason: str,
        ...
        from strategy_es import close_trade
        ...
        try:
            ...
            with open(path, "a", newline="", encoding="utf-8") as f:
                ...
                w.writerow({"timestamp_utc": datetime.now(timezone.utc).isoformat(),
                    "system": "ESTrader", "direction": t.direction, "entry_price": t.entry_price,
    ...
    def print_status(self) -> None:
        log.info("=" * 60)
        log.info("ESTrader AI -- Stanley Paper Trader Status")
        log.info("-" * 60)
